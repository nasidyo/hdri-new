<?php
    ...
    while( $row = sqlsrv_fetch_array( $stmt, SQLSRV_FETCH_ASSOC) ) {
        ...
        (select sum(pmt.TotalValue)as TotalValue, sum(pmt.Volumn) as Volumn 
            from PersonMarket_TD pmt WHERE pmt.Market_idMarket = '2' and pmt.YearID = '".$_POST["yearsId"]."' and pmt.Area_idArea = '".$_POST["area_Id"]."' and pmt.TypeOfArgi_idTypeOfArgi = '".$row["idTypeOfArgi"]."') t1,
        (select  sum(pmt.TotalValue)as TotalValue, sum(pmt.Volumn) as Volumn 
            from PersonMarket_TD pmt WHERE pmt.Market_idMarket = '3' and pmt.YearID ='".$_POST["yearsId"]."' and pmt.Area_idArea = '".$_POST["area_Id"]."' and pmt.TypeOfArgi_idTypeOfArgi = '".$row["idTypeOfArgi"]."') t2,
            (select sum(pmt.TotalValue)as TotalValue, sum(pmt.Volumn) as Volumn 
            from PersonMarket_TD pmt WHERE pmt.Market_idMarket = '4' and pmt.YearID = '".$_POST["yearsId"]."' and pmt.Area_idArea = '".$_POST["area_Id"]."' and pmt.TypeOfArgi_idTypeOfArgi = '".$row["idTypeOfArgi"]."') t3,
            (select  sum(pmt.TotalValue)as TotalValue, sum(pmt.Volumn) as Volumn 
            from PersonMarket_TD pmt WHERE pmt.Market_idMarket = '6' and pmt.YearID = '".$_POST["yearsId"]."' and pmt.Area_idArea = '".$_POST["area_Id"]."' and pmt.TypeOfArgi_idTypeOfArgi = '".$row["idTypeOfArgi"]."') t4,
            (select  sum(pmt.TotalValue)as TotalValue, sum(pmt.Volumn) as Volumn 
            from PersonMarket_TD pmt WHERE pmt.Market_idMarket = '7' and pmt.YearID = '".$_POST["yearsId"]."' and pmt.Area_idArea = '".$_POST["area_Id"]."' and pmt.TypeOfArgi_idTypeOfArgi = '".$row["idTypeOfArgi"]."') t5,
            (select sum(pmt.TotalValue)as TotalValue, sum(pmt.Volumn) as Volumn 
            from PersonMarket_TD pmt WHERE pmt.Market_idMarket = '5' and pmt.YearID = '".$_POST["yearsId"]."' and pmt.Area_idArea = '".$_POST["area_Id"]."' and pmt.TypeOfArgi_idTypeOfArgi = '".$row["idTypeOfArgi"]."') t6
        ";
