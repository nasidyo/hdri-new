<?php
    ...
    $sql = "SELECT t1.YearID, t1.totalsale, t2.totalpaln, t1.totalVSale,  t2.totalVplan
        FROM (
            SELECT SUM(pmt.TotalValue) as totalsale, pmt.YearID , SUM(pmt.Volumn) as totalVSale
                FROM PersonMarket_TD pmt
                GROUP BY pmt.YearID ) t1,
            (SELECT tpt.YearTarget_YearID , SUM(tpt.Total) as totalpaln, SUM(tpt.Weight) as totalVplan
