<?php
    ...
    if($basinId == '0'){
        $sql = "SELECT DISTINCT rb.idRiverBasin , rb.nameRiverBasin 
            FROM MainBasin rb 
            WHERE rb.idRiverBasin NOT IN (1,22) ORDER BY rb.nameRiverBasin ";
    }else{
    ...
    while( $row = sqlsrv_fetch_array( $stmt, SQLSRV_FETCH_ASSOC) ) {
        ...
        if($basinId == '0'){
            ...
            (select sum(pmt.TotalValue)as TotalValue, sum(pmt.Volumn) as Volumn 
                ...
                WHERE a.target_area_type_id in (3,5,10) AND rb.idRiverBasin NOT IN (12) and pmt.Market_idMarket = '2' and pmt.YearID = '".$_POST["yearsId"]."' and rb.idRiverBasin = '".$row["idRiverBasin"]."') t1,
            (select  sum(pmt.TotalValue)as TotalValue, sum(pmt.Volumn) as Volumn 
                from PersonMarket_TD pmt 
                INNER JOIN Area a ON a.idArea = pmt.Area_idArea
                INNER JOIN MainBasin rb ON rb.idRiverBasin = a.RiverBasin_idRiverBasin
                WHERE a.target_area_type_id in (3,5,10) AND rb.idRiverBasin NOT IN (12) and pmt.Market_idMarket = '3' and pmt.YearID ='".$_POST["yearsId"]."' and rb.idRiverBasin = '".$row["idRiverBasin"]."') t2,
                (select sum(pmt.TotalValue)as TotalValue, sum(pmt.Volumn) as Volumn 
                from PersonMarket_TD pmt 
                INNER JOIN Area a ON a.idArea = pmt.Area_idArea
                INNER JOIN MainBasin rb ON rb.idRiverBasin = a.RiverBasin_idRiverBasin
                WHERE a.target_area_type_id in (3,5,10) AND rb.idRiverBasin NOT IN (12) and pmt.Market_idMarket = '4' and pmt.YearID = '".$_POST["yearsId"]."' and rb.idRiverBasin = '".$row["idRiverBasin"]."') t3,
                (select  sum(pmt.TotalValue)as TotalValue, sum(pmt.Volumn) as Volumn 
                from PersonMarket_TD pmt 
                INNER JOIN Area a ON a.idArea = pmt.Area_idArea
                INNER JOIN MainBasin rb ON rb.idRiverBasin = a.RiverBasin_idRiverBasin
                WHERE a.target_area_type_id in (3,5,10) AND rb.idRiverBasin NOT IN (12) and pmt.Market_idMarket = '6' and pmt.YearID = '".$_POST["yearsId"]."' and rb.idRiverBasin = '".$row["idRiverBasin"]."') t4,
                (select  sum(pmt.TotalValue)as TotalValue, sum(pmt.Volumn) as Volumn 
                from PersonMarket_TD pmt 
                INNER JOIN Area a ON a.idArea = pmt.Area_idArea
                INNER JOIN MainBasin rb ON rb.idRiverBasin = a.RiverBasin_idRiverBasin
                WHERE a.target_area_type_id in (3,5,10) AND rb.idRiverBasin NOT IN (12) and pmt.Market_idMarket = '7' and pmt.YearID = '".$_POST["yearsId"]."' and rb.idRiverBasin = '".$row["idRiverBasin"]."') t5,
                (select sum(pmt.TotalValue)as TotalValue, sum(pmt.Volumn) as Volumn 
                from PersonMarket_TD pmt 
                INNER JOIN Area a ON a.idArea = pmt.Area_idArea
                INNER JOIN MainBasin rb ON rb.idRiverBasin = a.RiverBasin_idRiverBasin
                WHERE a.target_area_type_id in (3,5,10) AND rb.idRiverBasin NOT IN (12) and pmt.Market_idMarket = '5' and pmt.YearID = '".$_POST["yearsId"]."' and rb.idRiverBasin = '".$row["idRiverBasin"]."') t6
            ";
        }else{
            ...
            (select sum(pmt.TotalValue)as TotalValue, sum(pmt.Volumn) as Volumn 
                ...
                INNER JOIN Area a ON a.idArea = pmt.Area_idArea
                INNER JOIN MainBasin rb ON rb.idRiverBasin = a.RiverBasin_idRiverBasin
                WHERE a.target_area_type_id in (3,5,10) AND rb.idRiverBasin NOT IN (12) and pmt.Market_idMarket = '2' and pmt.YearID = '".$_POST["yearsId"]."' and pmt.Area_idArea = '".$row["idArea"]."') t1,
            (select  sum(pmt.TotalValue)as TotalValue, sum(pmt.Volumn) as Volumn 
                from PersonMarket_TD pmt 
                INNER JOIN Area a ON a.idArea = pmt.Area_idArea
                INNER JOIN MainBasin rb ON rb.idRiverBasin = a.RiverBasin_idRiverBasin
                WHERE a.target_area_type_id in (3,5,10) AND rb.idRiverBasin NOT IN (12) and pmt.Market_idMarket = '3' and pmt.YearID ='".$_POST["yearsId"]."' and pmt.Area_idArea = '".$row["idArea"]."') t2,
                (select sum(pmt.TotalValue)as TotalValue, sum(pmt.Volumn) as Volumn 
                from PersonMarket_TD pmt
                INNER JOIN Area a ON a.idArea = pmt.Area_idArea
                INNER JOIN MainBasin rb ON rb.idRiverBasin = a.RiverBasin_idRiverBasin
                WHERE a.target_area_type_id in (3,5,10) AND rb.idRiverBasin NOT IN (12) and pmt.Market_idMarket = '4' and pmt.YearID = '".$_POST["yearsId"]."' and pmt.Area_idArea = '".$row["idArea"]."') t3,
                (select  sum(pmt.TotalValue)as TotalValue, sum(pmt.Volumn) as Volumn 
                from PersonMarket_TD pmt 
                INNER JOIN Area a ON a.idArea = pmt.Area_idArea
                INNER JOIN MainBasin rb ON rb.idRiverBasin = a.RiverBasin_idRiverBasin
                WHERE a.target_area_type_id in (3,5,10) AND rb.idRiverBasin NOT IN (12) and pmt.Market_idMarket = '6' and pmt.YearID = '".$_POST["yearsId"]."' and pmt.Area_idArea = '".$row["idArea"]."') t4,
                (select  sum(pmt.TotalValue)as TotalValue, sum(pmt.Volumn) as Volumn 
                from PersonMarket_TD pmt
                INNER JOIN Area a ON a.idArea = pmt.Area_idArea
                INNER JOIN MainBasin rb ON rb.idRiverBasin = a.RiverBasin_idRiverBasin
                WHERE a.target_area_type_id in (3,5,10) AND rb.idRiverBasin NOT IN (12) and pmt.Market_idMarket = '7' and pmt.YearID = '".$_POST["yearsId"]."' and pmt.Area_idArea = '".$row["idArea"]."') t5,
                (select sum(pmt.TotalValue)as TotalValue, sum(pmt.Volumn) as Volumn 
                from PersonMarket_TD pmt
                INNER JOIN Area a ON a.idArea = pmt.Area_idArea
                INNER JOIN MainBasin rb ON rb.idRiverBasin = a.RiverBasin_idRiverBasin
                WHERE a.target_area_type_id in (3,5,10) AND rb.idRiverBasin NOT IN (12) and pmt.Market_idMarket = '5' and pmt.YearID = '".$_POST["yearsId"]."' and pmt.Area_idArea = '".$row["idArea"]."') t6
            ";
        }
        ...
        while( $row2 = sqlsrv_fetch_array( $stmt2, SQLSRV_FETCH_ASSOC) ) {
            ...
            $data2 .="<td style='text-align: right'>".number_format($total1)."</td><td style='text-align: right'>".number_format($total2)."</td>";
        }
