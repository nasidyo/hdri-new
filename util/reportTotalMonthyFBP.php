<?php
    ...
    if($basinId != '0'){
        $sql ="SELECT DISTINCT a.target_area_type_id, a.areaType
            FROM Area a
            WHERE a.RiverBasin_idRiverBasin NOT IN (1,22) and a.target_area_type_id ='".$basinId."'";
        $return_arr = array();
                ...
                FROM 
                    ...
                    FROM MonthOfYear moy ) t1
                        LEFT JOIN (SELECT SUM(tpt.Total ) as total, tpt.month_id 
                            ...
                            INNER JOIN Area a ON tpt.Area_idArea = a.idArea
                        ...
                        LEFT JOIN (SELECT SUM(pmt.TotalValue ) as TotalValue, pmt.MonthNo 
                            ...
                            INNER JOIN Area a ON pmt.Area_idArea = a.idArea
