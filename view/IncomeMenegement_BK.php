                            ...
                            <div class="card-body " style=" background-color: olivedrab; " >
                                <div class="card">
                                    ...
                                    <div class=" collapse card-body multi-collapse" id='criteria'>
                                        ...
                                        <div class="col-sm-4">
                                            <select class="form-control">
                                                <option value="1">ตลาดชุมชน</option>
                                                <option value="2">งานอีเวนท์</option>
                                                <option value="1">ขายออนไลน์</option>
                                            </select>
                                        </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <form>
                                            ...
                                            <div class="form-group row">
                                                 <div class="col-sm-5"></div>
                                                    <button type="button" class="btn btn-primary col-sm-2" id="clear_person"><i class="menu-icon fa fa-add"> </i>  เพิ่มในรายการ </button>
                                                    <div class="col-sm-5"></div>
                                            </div>
                                            ...
                                            <div class="col-sm-8"></div>
                                                <label class="col-sm-2 col-form-label">เป็นเงินทั้งหมด</label>
                                                    <div class="col-sm-2">
                                                        <input type="text" class="form-control" name="custmer" placeholder="">
                                                    </div>
                                                </div>
                                            <div class="form-group row">
                                                <label class="col-sm-1 col-form-label">รับเงิน</label>
                                                    <div class="col-sm-3">
                                                        <input type="text" class="form-control" name="custmer" placeholder="">
                                                    </div>

                                                    <label class="col-sm-1 col-form-label">ค้างชำระ</label>
                                                    <div class="col-sm-3">
                                                        <input type="text" class="form-control" name="custmer" placeholder="">
                                                    </div>

                                                    <label class="col-sm-1 col-form-label">ส่วนลด</label>
                                                    <div class="col-sm-3">
                                                        <input type="text" class="form-control" name="custmer" placeholder="">
                                                    </div>
                                            </div>
