...
<body>
  ...
  ?>
    ...
    <div id="right-panel" class="right-panel">
        ...
        include 'modal/editIncomeOther.php';
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="row justify-content-between">
                                <div class="col-md-8 ">
                                    <strong class="card-title">รายการรายรับ </strong>
                                ...
                                <div class="card">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" id="income_detail" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                            ...
                            <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-2">
                                                <button type="button" class="btn btn-primary " id="search_person"  data-toggle="modal" data-target="#addIncomeOther"><i class="menu-icon fa fa-plus"></i>  เพิ่มรายการค่าใช้จ่าย</button>
                                            </div>
                                        </div>


                                        <table id="OtherIncomeTable" class="table table-striped table-bordered" style=" text-align: center;border-left-width: 0; ">
                                            <thead>
   ...
   <script src="../assets/hrdi_js/moment.min.js"></script>
    ...
    <script src="../assets/hrdi_js/cooperativeJS/OtherIncomeManagement.js"></script>
    <script src="../assets/hrdi_js/cooperativeJS/addIncomeOtherProduct.js"></script>
    <script src="../assets/hrdi_js/cooperativeJS/editIncomeOtherProduct.js"></script>
