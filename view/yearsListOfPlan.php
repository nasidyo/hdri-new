...
<body>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="row justify-content-between">
                                    <div class="col-md-10 ">
                                        <strong class="card-title">ตารางเป้าหมายรายได้และผลผลิต</strong>
                                    </div>
                                    <div class="col-md-2 ">
                            ...
                            <div class="card-body">
                                <div class="card">
                                    <div class="card-header">
                                        <strong class="card-title">รายการเป้าหมายรายได้และผลผลิตประจำปี [
                                            <?php
                                                $result = '';
                                                $sql = "( SELECT areaName
                                                FROM
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="yearsOfPlan-Table" name="yearsOfPlan-Table" class="table table-striped table-bordered">
                                            <thead>
                                                <tr>
                                                    <th>&nbsp;</th>
                                                    <th>ปีงบประมาณ</th>
                                                    <th>วันที่บันทึกแผน</th>
                                                    <th>วันที่แก้ไข</th>
                                                    <th>วันที่ส่งแผน</th>
                                                    <th>สถานะแผน</th>
                                                    <th>&nbsp;</th>
                                                    <th>
                                                        <i class="fa fa-edit"style=" color: blue;"></i> เพิ่มเป้าหมาย<br/>
                                                        <i class="fa fa-file-text-o"style=" color: green;"></i> ภาพรวมเป้าหมาย<br/>
                                                    </th>
                                                </tr>
                                            </thead>
                                            <tbody></tbody>
    ...
    <script src="../assets/hrdi_js/planProduct.js"></script>
