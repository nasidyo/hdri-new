...
<body>
  ...
  ?>
    ...
    <div id="right-panel" class="right-panel">
        ...
        include 'modal/addNewAgri.php';
        include 'modal/editAgri.php';
        include 'modal/viewSpeciesAgri.php';
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body ">
                                <div class="card">
                                    ...
                                    <!-- <div class="card-body"> -->
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-5">
                                                <select class="form-control"name="idTypeOfStandSearch" id="idTypeOfStandSearch" style="width:100%;">
                                ...
                                <div class="card">
                                    <div class="card-header" >
                                            <strong class="card-title">ตารางพืชที่ได้รับการส่งเสริม</strong>
                                    </div>

                                    <div class="card-body">
                                        <div class="form-group row">
                                            <div class="col-md-2">
                                                <button type="button" class="btn btn-primary " id="addAgriBtn"><i class="menu-icon fa fa-plus"></i>  เพิ่มพืชที่ได้รับการส่งเสริม</button>
                                            </div>
                                        </div>
                                        ...
                                        <table class="table table-striped table-bordered" id="tableAgricultural">
                                            <thead>
                                                <tr style=" border-left-width: thick;">
                                                    ...
                                                    <th style="  text-align: center; ">มาตรฐาน</th>
                                                    <th style="  text-align: center; ">หน่วยวัด</th>
                                                    <th style="  text-align: center; ">เกรด</th>
                                                    <th style="  text-align: center; ">พันธุ์พืช/แก้ไข/ลบ</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                            </tbody>
