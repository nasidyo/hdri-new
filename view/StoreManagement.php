...
<body>
  ...
  ?>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="row justify-content-between">
                                <div class="col-md-8 ">
                                    <strong class="card-title">การจัดการคลังสินค้า </strong>
                            ...
                            <div class="card-body " style=" background-color: olivedrab; " >
                                <div class="card">
                                    ...
                                    <div class="card-body multi-collapse" id='criteria'>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">คงเหลือ</label>
                                            <div class="col-sm-2">
                                                <select class="form-control" name="filter" id="filter"  style="width: 100%;">
                                                    <option value="max">มากกว่าเท่ากับ</option>
                                                    <option value="min">น้อยกว่าเท่ากับ</option>
                                                    <option value="equal">เท่ากับ</option>
                                                </select>
                                            </div>
                                            <div class="col-sm-3">
                                               <input type="number" id="params" class="form-control">
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-1">
                                                <button type="button" class="btn btn-primary " id="search_order"><i class="menu-icon fa fa-search"></i>  ค้นหา</button>
                                            </div>
                                            <div class="col-md-1 ">
                            ...
                            <div class="card-body">
                                        ...
                                        <table id="orderTable" class="table table-striped table-bordered" style=" text-align: center;border-left-width: 0;width: 100%; ">
                                            <thead>
                                                <tr style=" border-left-width: thick; ">
                                                    <th  style=" vertical-align: middle; ">รายการ</th>
                                                    <th  style=" vertical-align: middle; ">หน่วยวัด</th>
    ...
    <script src="../assets/hrdi_js/cooperativeJS/orderManagement.js"></script>
    <script src="../assets/hrdi_js/cooperativeJS/addProduct.js"></script>
    <script src="../assets/hrdi_js/cooperativeJS/editProduct.js"></script>
