...
?>
<div class="modal fade" id="EditBankAccount" tabindex="-1" role="dialog" aria-labelledby="EditBankAccount" style="display: none;" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document" style=" max-width: 600px; ">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="EditBankAccount">เพิ่มบัญชีธนาคาร</h5>
