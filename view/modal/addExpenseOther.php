<div class="modal fade" id="addExpenseOther" tabindex="-1" role="dialog" aria-labelledby="addExpenseOther" style="display: none;" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="addExpenseOther">เพิ่มรายการค่าใช้จ่าย</h5>
                            ...
                            <div class="modal-body" style=" padding: 1.5rem; ">
                                    ...
                                    <div class="form-group row" style="display:none">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" name="product_id" placeholder="รหัสรายจ่าย" readonly>
                                        </div>
                                    ...
                                    <label for="inputext" class="col-sm-2 col-form-label">ชื่อรายการ</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" name="expense_detail" id="expense_detail" placeholder="ชื่อรายการ" maxlength="300">
                                        </div>
                                    ...
                                    <div class="form-group row">
                                           ...
                                           <div class="col-sm-8">
                                              <textarea name="textarea-input" id="comment" rows="9" placeholder="Content..." class="form-control" maxlength="200"></textarea>
                                           </div>
                                   </div>
