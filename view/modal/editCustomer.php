<div class="modal fade" id="editCustomer" tabindex="-1" role="dialog" aria-labelledby="editCustomer" style="display: none;" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="editCustomer">แก้ไขผู้รับซื้อ</h5>
                            ...
                            <div class="modal-body" style=" padding: 1.5rem; ">
                                    <from>
                                    <input type="hidden" class="form-control"name="customer_id" id="customer_id"  style="width: 100%;">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-primary" id="editCustomerBtn">ตกลง</button>
                            </div>
                        </div>
                    </div>
                </div>
