...
<div class="modal-dialog modal-lg" role="document" style=" max-width: 1140px; ">
  <div class="modal-content">
    <div class="modal-header">
      <h5 class="modal-title" id="addFarmerModalLabel">เพิ่มข้อมูลเกษตกร</h5>
             ...
             <div class="card-body">
               ...
               <div class="card">
                ...
                <!-- <label for="inputext" class="col-sm-2 col-form-label">รหัสเกษตรกร</label>
                 ...
                 <div class="col-sm-4">
                   <input type="number" class="form-control" name="argid" placeholder="เลขที่บัตรประชาชน" pattern="/^-?\d+\.?\d*$/"  onKeyPress="if(this.value.length==13) return false;"  onkeydown="javascript: return event.keyCode == 69 ? false : true" >
                 </div>
                </div>
          ...
          <div class="card">
            ...
            <div class="form-group row">
              ...
              <label  class="col-sm-2 col-form-label">ถนน</label>
                 ...
                 <div class="col-sm-2">
                   <input type="number" class="form-control" name="argTel" placeholder="เบอร์โทร" pattern="/^-?\d+\.?\d*$/"  onKeyPress="if(this.value.length==10) return false;" onkeydown="javascript: return event.keyCode == 69 ? false : true">
                 </div>
