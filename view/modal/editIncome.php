...
?>
<div class="modal fade" id="editIncome" tabindex="-1" role="dialog" aria-labelledby="editIncome" style="display: none;" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document" style=" max-width: 1140px; ">
                        <div class="modal-content" style=" padding: 25px; ">
                            <div class="modal-header">
                                <h5 class="modal-title" id="editIncome">แก้ไขรายรับ</h5>
                                ...
                                <input type="hidden" id="income_id">
                                            <div class="form-group row">
                                                ...
                                                <label for="inputext" class="col-sm-2 col-form-label" style=" text-align: end; ">วันที่ :</label>
                                                        <div class="input-group date form_date col-md-3 receiveDateTmp" data-date="" data-date-format="dd MM yyyy" data-link-field="searchToDate" data-link-format="dd-mm-yyyy">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-4">
                                                <select class="form-control"name="product_add" id="product_add"  style="width: 100%;" disabled>
                                                </select>
                                                </div>
                                        ...
                                        <div id="other_div" style="display: none;">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-2">
                                                    <select class="form-control" id="income_other_id"  style="width: 100%;" disabled>
                                                    <option value='0'>กรุณาเลือก</option>
                                                            <?php
                                                                $sql2="  SELECT INCOME_OTHER_ID, INCOME_DETAIL, STATUS, COMMENT FROM INCOME_OTHER_TD where  STATUS ='Y' and INCOME_OTHER_ID <> 0 ";
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                             ...
                                             <button type="button" class="btn btn-primary" id="addDebt" style="float: right;margin-bottom: 10px;" data-toggle="modal" data-target="#debtIncomeAdd"><i class="fa fa-plus"></i> เพิ่มรายการชำระหนี้</button>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <label class="col-sm-2 col-form-label" style=" text-align: right; ">จ่ายเงิน :</label>
                                                    <div class="col-sm-2">
                                                        <input type="number" class="form-control" name="receive_amount" id="receive_amount" placeholder="" disabled>
                                                    </div>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-primary" id="editIncomeBtn">ตกลง</button>
                            </div>
                        </div>
                    </div>
                </div>
