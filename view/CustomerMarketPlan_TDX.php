...
<title>การจัดการข้อมูลการรับซื้อผลผลิต </title>
...
<body>
	...
	<div id="right-panel" class="right-panel">
        ...
        require '../util/typeOfAgri.php';
         ...
         include 'modal/addCustomerMarketPlanTD.php';
        include 'modal/editCustomerMarketPlanTD.php';
						...
						<div class="card">
							<div class="card-header">
								...
								<div class="row justify-content-between">
									<div class="col-md-8 ">
										<strong class="card-title">จัดการการรับซื้อผลผลิต </strong>
									</div>
							...
							<div class="card-body ">
								<div class="card">
									...
									<div class="card">
										<div class="card-header">
											<strong class="card-title">ข้อมูลการรับซื้อผลผลิต </strong>
										</div>
										...
										<div class="card-body">
											...
											<div class="form-group row">
												...
												<div class="col-md-5"></div>
												<div class="col-md-2">
												 <button type="button" class="btn btn-primary " id="addCustomerMarketPlanbtn"  data-toggle="modal" data-target="#addCustomerMarketPlan"><i class="menu-icon fa fa-plus"></i>  เพิ่มการรับซื้อผลผลิต </button>
												</div>
											</div>

											<table id="customerMarketPlanTable"
												...
												<thead>
													<tr style="border-left-width: thick;">
														...
														<th style="text-align: center;">มาตราฐาน</   </th>
														<th style="text-align: center;">การขนส่ง </   </th>
														<th style="text-align: center;">สถานะการติดต่อ </   </th>
		...
		<script src="../assets/hrdi_js/CustomerMarketPlant/customerMarketPlanManagement.js"></script>
		<script src="../assets/hrdi_js/CustomerMarketPlant/addCustomerMarketPlan.js"></script>
		<script src="../assets/hrdi_js/CustomerMarketPlant/editCustomerMarketPlan.js"></script>
