...
<body>
  ...
  ?>
    ...
    <div id="right-panel" class="right-panel">
        ...
        include 'modal/addPlantHouse.php';
            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>จัดการข้อมูลพื้นที่เกษตรกร</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="row justify-content-between">
                                <div class="col-md-8 ">
                                    <strong class="card-title">จัดการข้อมูลพื้นที่เกษตรกร </strong>
                                </div>
                            ...
                            <div class="card-body ">
                                ...
                                <div class="card">
                                    <div class="card-header" >
                                            <strong class="card-title">ตารางพื้นที่เกษตรกร</strong>
                                    </div>

                                    <div class="card-body">
                                        <div class="form-group row">
                                            <div class="col-md-2">
                                                <button type="button" class="btn btn-primary" id="addPlantHouseBtnfrom" name="addPlantHouseBtnfrom"><i class="menu-icon fa fa-plus"></i> เพิ่มข้อมูลโรงเรือน</button>
                                            </div>
                                        </div>

                                        <table class="table table-striped table-bordered" id="plantHouse-table">
                                            <thead>
                                                <tr style=" border-left-width: thick;">
                                                    ...
                                                    <th style="  text-align: center; width: 13%; ">รหัสแปลงปลูก</th>
                                                    <th style="  text-align: center;">พื้นที่แปลงปลูก</th>
    ...
    <script src="../assets/hrdi_js/planHouseJs.js"></script>
