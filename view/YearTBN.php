...
<body>
  ...
  ?>
    ...
    <div id="right-panel" class="right-panel">
        ...
        include 'modal/addYearTarget.php';
        include 'modal/editYearTarget.php';
        ?>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="row justify-content-between">
                                <div class="col-md-8 ">
                                    <strong class="card-title">จัดการปีงบประมาณ </strong>
                                </div>
                            ...
                            <div class="card-body ">
                                <div class="card">
                                    <div class="card-header" >
                                            <strong class="card-title">ตารางปีงบประมาณ</strong>
                                    </div>

                                    <div class="card-body">
                                        <div class="form-group row">
                                            <div class="col-md-2">
                                                <button type="button" class="btn btn-primary " id="createYearsTarget"><i class="menu-icon fa fa-plus"></i> เพิ่มข้อมูลปีงบประมาณ</button>
                                            </div>
                                        </div>
    ...
    <script src="../assets/hrdi_js/yearTargetJs.js"></script>
