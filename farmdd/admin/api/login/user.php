    ...
    class User {
        ...
        public function check_login_withoutAD($username, $password) { //Check login with out AD server
            ...
            if(sqlsrv_fetch( $stmt )) {
                ...
                $_SESSION['msg'] = "ไม่สามารถเข้าระบบได้ กรุณาตรวจสอบ Username และ Password จากผู้ดูแลระบบ Sever ของสถาบันอีกครั้ง";
                return false;
            }
        }
        ...
        public function loginLogTD($username) {
            ...
            $query = "INSERT INTO LoginLogTD (username, loginDate) VALUES (?, ?)";
            $params = array($username, $time);
