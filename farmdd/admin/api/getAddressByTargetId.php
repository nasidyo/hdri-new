...
$query = "SELECT * FROM vLinkAreaDetail WHERE target_id = ".$_GET['targetId']." ";
...
if ($stmt->execute()) {
  ...
  $prefixArray = array();
  $prefixArray["vTargetAddressDetail"] = array();
  ...
  while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
    ...
    array_push($prefixArray["vTargetAddressDetail"], $prefix_item);
  }
