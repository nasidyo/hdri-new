...
$query = "SELECT * FROM vLinkAreaDetail WHERE VILLAGE_ID = ".$_GET['vId']." AND target_id = ".$_GET['targetId']."";
...
if ($stmt->execute()) {
  ...
  $prefixArray = array();
  $prefixArray["villageDetail"] = array();
  ...
  while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
    ...
    array_push($prefixArray["villageDetail"], $prefix_item);
  }
