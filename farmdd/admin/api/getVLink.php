...
$query = "SELECT * FROM vLinkAreaDetail WHERE PROVINCE_ID IN (50, 55, 57, 58, 63, 71, 51, 56, 62, 65, 67, 53)";
...
if ($stmt->execute()) {
  ...
  $prefixArray = array();
  $prefixArray["vTargetDetail"] = array();
  ...
  while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
    ...
    array_push($prefixArray["vTargetDetail"], $prefix_item);
  }
