...
LEFT JOIN TypeOfSeller_MK ON SellerMember_MK.idTypeOfSeller_MK = TypeOfSeller_MK.idTypeOfSeller_MK
LEFT JOIN SpeciesArgi_TD ON ProductOfMember_MK.speciesArgi = SpeciesArgi_TD.species_Id WHERE convert(varchar(10), addDate , 102) = convert(varchar(10), getdate(), 102)";
