...
INNER JOIN SellerMember_MK ON ProductOfMember_MK.idSellerMember = SellerMember_MK.idSellerMember WHERE suggestSta = 1
ORDER BY idProductOfMember_MK DESC
...
if ($stmt->execute()) {
  ...
  $productArr = array();
  $productArr["suggestProduct"] = array();
  while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
    ...
    array_push($productArr["suggestProduct"], $productItem);
  }
