    ...
    <div class="content-wrapper" id="buyerRegister">
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">แก้ไขสมาชิกผู้ขาย</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="index.php">หน้าแรก</a></li>
                <li class="breadcrumb-item active">แก้ไขสมาชิกผู้ขาย</li>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
          <div class="row">
      ...
      <section class="content">
        <div class="col-lg-8 mx-auto">
          <b-card header="แก้ไขสมาชิกผู้ขาย" header-text-variant="white" header-tag="header" header-bg-variant="success">
            <b-card-text>
              <b-row>
                <b-col>
                ...
                <b-col>
                  ...
                  <b-form-input id="input-live" v-model="sellerForm.firstName" :state="nameState" placeholder="ชื่อเกษตรกร / กลุ่ม" trim></b-form-input>
              ...
              <b-button @click="submitForm" type="button" :disabled="isDisabled" block variant="primary">แก้ไขสมาชิกผู้ขาย</b-button>
            </b-card-text>
          </b-card>
        </div>
      </section>
  ...
  var app = new Vue({
    ...
    methods: {
        ...
        axios
          ...
          .then((res) => {
            ...
            if (res.data.vTargetDetail.length > 0) {
              ...
              this.getArea();
              this.findTumbolByAmpCode(this.sellerForm.ampCode, this.sellerForm.vProvinceId);
            }
          });
      },
      ...
      submitForm() {
        ...
        formData.append("statusOfMember", this.sellerForm.statusOfMember);
        ...
        axios
          .post(
            "https://farmtd.hrdi.or.th/farmdd/admin/api/member/postUpdateSeller.php",
            formData, {
              headers: {
      ...
      getSellerFromId() {
        ...
        usernameData.append('username', this.sellerForm.username);
        axios.post('https://farmtd.hrdi.or.th/farmdd/admin/api/member/postSellerFromId.php', usernameData).then((res) => {
          if (res.data.sellerUser[0] !== 0) {
            let sellerData = res.data.sellerUser[0];
            this.url = `https://farmtd.hrdi.or.th/farmdd/admin/upload/profile/${res.data.sellerUser[0].sellerImg}`;
            this.confirmPassword = sellerData.password
            this.sellerForm = {
              idTypeOfSeller: sellerData.idTypeOfSeller_MK,
              prefix: sellerData.idPrefix,
              firstName: sellerData.firstName,
              lastName: sellerData.lastName,
              username: sellerData.username,
              phoneNumber: sellerData.phoneNumber,
              email: sellerData.email,
              idCard: sellerData.idCard,
              gender: sellerData.gender,
              password: sellerData.password,
              vProvinceId: sellerData.vProvinceId_MK,
              vLinkAreaDetailId: sellerData.vLinkAreaDetailId_MK,
              productType: sellerData.productType.split(','),
              address: sellerData.address,
              statusOfMember: sellerData.statusOfMember,
              img: [],
              postcode: sellerData.postCode,
              moo: sellerData.moo,
              road: sellerData.road,
              tambolCode: sellerData.tambolCode,
              ampCode: sellerData.ampCode,
              zipcode: sellerData.postCode,
              groupName: sellerData.groupName,
              shopName: sellerData.shopName,
              brandName: sellerData.brandName,
              lineId: sellerData.lineID,
              facebookName: sellerData.facebookName,
            }
            this.findAreaByProvince(this.sellerForm.vProvinceId);
            
            console.log('sellerForm', this.sellerForm);
          }
        }).catch((err) => {
          console.log(err);
        })
    ...
    mounted() {
      ...
      this.sellerForm.username = urlParams.get('username');
      this.idMember = urlParams.get('idMember');
      this.getPrefix();
      this.getProvince();
      this.getSellerType();
      this.getSellerFromId(); 
      localStorage.table = 'Seller';
    },
  })
</script>
