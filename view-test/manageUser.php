...
<body>
  ...
  ?>
    ...
    <div id="right-panel" class="right-panel">
        ...
        include 'modal/addNewUser.php';
        include 'modal/editUser.php';
        include 'modal/lookupUserFromAD.php';
        ?>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body ">
                                <div class="card">
                                    ...
                                    <!-- <div class="card-body"> -->
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">ระดับการเข้าถึง</label>
                                            <div class="col-sm-5">
                                                <select class="form-control" name="typeOfPermission" id="typeOfPermission" style="width:100%;">
                                ...
                                <div class="card">
                                    <div class="card-header" >
                                        <strong class="card-title">ตารางผู้ใช้งานระบบ</strong>
                                    </div>

                                    <div class="card-body">
                                        <div class="form-group row">
                                            <div class="col-md-2">
                                                <button type="button" class="btn btn-primary " id="addNewUserBtn"><i class="menu-icon fa fa-plus"></i> เพิ่มผู้ใช้งานใหม่</button>
                                            </div>
                                        </div>

                                        <table class="table table-striped table-bordered" id="tableUserPermissionList">
                                            <thead>
                                                <tr style=" border-left-width: thick;">
                                                    <th style="  text-align: center; ">รหัส</th>
                                                    <th style="  text-align: center; ">ชื่อ-นามสกุล</th>
                                                    <th style="  text-align: center; ">ชื่อบัญชีผู้ใช้</th>
                                                    <th style="  text-align: center; ">E-mail</th>
                                                    <th style="  text-align: center; ">ระดับการเข้าถึง</th>
    ...
    <script src="../assets/hrdi_js/ManagerUser.js"></script>
