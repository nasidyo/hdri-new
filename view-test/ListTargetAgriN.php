...
<body>
  ...
  ?>
    ...
    <div id="right-panel" class="right-panel">
        ...
        include 'modal/addNewTargetAgri.php';
        include 'modal/editTargetAgri.php';
        ?>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="row justify-content-between">
                                <div class="col-md-8 ">
                                    <strong class="card-title">ข้อมูลพืชและพื้นที่ </strong>
                                </div>
                            ...
                            <div class="card-body ">
                                <div class="card">
                                    ...
                                    <!-- <div class="card-body"> -->
                                        ...
                                        <!-- <div class="form-group row">
                                            ...
                                            <div class="col-sm-5">
                                                <select class="form-control"name="idTypeOfStandSearch" id="idTypeOfStandSearch">
                                ...
                                <div class="card">
                                    <div class="card-header" >
                                            <strong class="card-title">ตารางพืชและพื้นที่</strong>
                                    </div>

                                    <div class="card-body">
                                        <div class="form-group row">
                                            <div class="col-md-2">
                                                <button type="button" class="btn btn-primary " id="addTargetAgriBtn"><i class="menu-icon fa fa-plus"></i> เพิ่มพืชและพื้นที่</button>
                                            </div>
                                        </div>

                                        <table class="table table-striped table-bordered" id="listTargetAgri-table">
                                            <thead>
