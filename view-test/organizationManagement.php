...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        include '../view/modal/addOrg.php'  ;
        include '../view/modal/editOrg.php'
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <input type="hidden" value="<?php echo $_GET['account_year_id'];?>" id="account_year_id">
                            <input type="hidden" value="<?php echo $_GET['sub_group_id'];?>" id="sub_group_id">

                                <div><strong class="card-title"><span id="sub_group_name_2"></span></strong></div>
                            </div>
                            <div class="card-body">
                            <div><button type="button" class="btn btn-primary" id="add_person" style=" float: right;margin: 10px; "   data-toggle="modal" data-target="#AddOrg"><i class="menu-icon fa fa-plus"> </i>  เพิ่มโครงสร้างกลุ่มเกษตร </button> <button type="button" class="btn btn-primary" id="home" style="  float: right;margin: 10px; " >กลับหน้าหลัก</button></div>
                                <table id="orgTable" class="table table-striped table-bordered " style=" text-align: center;border-left-width: 0; width: 100%;">
    ...
    <script src="../assets/hrdi_js/cooperativeJS/org.js"></script>
