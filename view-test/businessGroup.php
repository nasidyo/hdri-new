...
<div class="wrapper">
  ...
  <!-- /.navbar -->
    ...
    <div class="content-wrapper">
        ...
        include 'modal/addBusiness.php';
        include 'modal/editBusiness.php';
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <input type="hidden" value="<?php echo $_GET['sub_group_id'];?>" id="sub_group_id">
                                ...
                                <div><strong class="card-title">ตารางแสดงข้อมูล <span id="sub_group_name_2"></span></strong></div>
                            </div>
                            <div class="card-body">
                            <div><button type="button" class="btn btn-primary" id="add_person" style=" float: right;margin: 10px; "   data-toggle="modal" data-target="#AddBusiness"><i class="menu-icon fa fa-plus"> </i>  สร้างธุระกิจกลุ่ม</button> <button type="button" class="btn btn-primary" id="home" style="  float: right;margin: 10px; " >กลับหน้าหลัก</button></div>
                                <table id="businessGroupTable" class="table table-striped table-bordered " style=" text-align: center;border-left-width: 0; width: 100%;">

                                    <thead>
                                        <tr style=" border-left-width: thick; ">
                                            <th  style=" vertical-align: middle; ">ธุรกิจ</th>
    ...
    <script src="../assets/hrdi_js/cooperativeJS/BusinessGroup.js"></script>
