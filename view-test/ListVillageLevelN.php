...
<body>
  ...
  ?>
    ...
    <div id="right-panel" class="right-panel">
        ...
        include 'modal/addVillageLevel.php';
        include 'modal/editVillageLevel.php';
        ?>
            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>จัดการมาตราฐานของหมู่บ้าน</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="row justify-content-between">
                                <div class="col-md-8 ">
                                    <strong class="card-title">จัดการมาตราฐานของหมู่บ้าน </strong>
                                </div>
                            ...
                            <div class="card-body ">
                                <div class="card">
                                    ...
                                    <!-- <div class="card-body"> -->
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                                <select class="form-control" name="village_id" id="village_id" style="width:100%;">
                                                    <option value="0">กรุณาเลือก</option>
                                                </select>
                                            </div>
                                        </div>
                                ...
                                <div class="card">
                                    <div class="card-header" >
                                            <strong class="card-title">ตารางมาตราฐานของหมู่บ้าน</strong>
                                    </div>

                                    <div class="card-body">
                                        <div class="form-group row">
                                            <div class="col-md-2">
                                                <button type="button" class="btn btn-primary " id="createVillageLevelBtn"><i class="menu-icon fa fa-plus"></i> เพิ่มข้อมูลมาตราฐานหมู่บ้าน</button>
                                            </div>
                                        </div>

                                        <table class="table table-striped table-bordered" id="villageLevel-table">
                                            <thead>
                                                <tr style=" border-left-width: thick;">
                                                    ...
                                                    <th style="  text-align: center; width: 15%; ">ระดับการส่งเสริม</th>
    ...
    <script src="../assets/hrdi_js/villageLevelJs.js"></script>
