<div class="modal fade" id="editYearEarnPay" tabindex="-1" role="dialog" aria-labelledby="editYearEarnPay" style="display: none;" aria-hidden="true">
                    <div class="modal-dialog modal-md" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="editYearEarnPay">เพิ่มรายรับรายจ่าย</h5>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-primary" id="editEarnPayBtn">ตกลง</button>
                            </div>
                        </div>
                    </div>
                </div>
