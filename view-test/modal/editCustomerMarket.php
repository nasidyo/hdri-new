...
<div class="modal fade bd-example-modal-xl" id="editFarmer" tabindex="-1" role="dialog" aria-labelledby="addFarmerModalLabel" aria-hidden="true">
<div class="modal-dialog modal-lg" role="document" style=" max-width: 1140px; ">
  <div class="modal-content">
    <div class="modal-header">
      <h5 class="modal-title" id="addFarmerModalLabel">แก้ไขข้อมูลเกษตรกร</h5>
             ...
             <div class="card-body">
               ...
               <div class="form-group row">
                ...
                <label  class="col-sm-2 col-form-label">ปีเกิด</label>
                 <div class="col-sm-4">
                   <input type="date" class="form-control" name="argbirth" placeholder="ปีเกิด">
                 </div>
