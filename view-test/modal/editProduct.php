<div class="modal fade" id="editProduct" tabindex="-1" role="dialog" aria-labelledby="addProduct" style="display: none;" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="addProduct">แก้ไขสินค้า</h5>
                            ...
                            <div class="modal-body" style=" padding: 1.5rem; ">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" id="order_id" name="order_id" placeholder="รหัสสินค้า" disabled>
                                        </div>
                                    ...
                                    <label for="inputext" class="col-sm-2 col-form-label">ชื่อสินค้า</label>
                                        <div class="col-sm-4">
                                           ...
                                           <label class="col-sm-2 col-form-label" disabled>จำนวน</label>
                                           <div class="col-sm-4">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-primary" id="updateProduct">ตกลง</button>
                            </div>
                        </div>
                    </div>
                </div>
