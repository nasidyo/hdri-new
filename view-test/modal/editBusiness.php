...
?>
<div class="modal fade" id="EditBusiness" tabindex="-1" role="dialog" aria-labelledby="EditBusiness" style="display: none;" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document" style=" max-width: 600px; ">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="AddBuEditBusinesssiness">แก้ไขธุระกิจกลุ่ม</h5>
