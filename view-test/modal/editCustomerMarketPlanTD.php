<div class="modal fade" id="editCustomerMarketPlan" tabindex="-1"
	role="dialog" aria-labelledby="editCustomerMarketPlan"
	style="display: none;" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="addCustomer">แก้ไขการรับซื้อสินค้า</h5>
			...
			<div class="modal-body" style="padding: 1.5rem;">
                ...
                <input type="hidden" id="customer_marketplan_id" >
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<select class="form-control" name="idCustomer" id="idCustomer" disabled>
				...
				<div class="form-group row">
					...
					<label for="inputext" class="col-sm-2 col-form-label">สินค้า</label>
					<div class="col-sm-10">
						<select class="form-control" name="idAgri" id="idAgri" disabled>
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-primary"
					id="updateCustomerMarketPlanBtn">ตกลง</button>
			</div>
		</div>
	</div>
</div>
