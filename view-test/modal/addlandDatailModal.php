...
<div class="modal fade" id="createLandDetailDialog" tabindex="-1" role="dialog" aria-labelledby="createLandDetailModalLabel" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createLandDetailModalLabel">เพิ่มข้อมูลพื้นที่เกษตกรใหม่</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" action="#" method="post" id="createLandDetail_form">
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="createLandDetailBtn" name="createLandDetailBtn" class="btn btn-primary">บันทึก</button>
            </div>
        </div>
    </div>
</div>
