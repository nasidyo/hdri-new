...
<body>
  ...
  ?>
    ...
    <div id="right-panel" class="right-panel">
        ...
        require '../util/loadAllDepartment.php';
        include 'modal/showListActivity.php';
        ?>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="row justify-content-between">
                                <div class="col-md-8 ">
                                    <strong class="card-title">System Log Access </strong>
                                </div>
                            ...
                            <div class="card-body ">
                                <div class="card">
                                    ...
                                    <!-- <div class="card-body"> -->
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">สังกัดสำนัก :</label>
                                            <div class="col-sm-4">
                                                <select class="form-control"name="departmentId" id="departmentId">
                                                    <option value='all'>เลือกทั้งหมด</option>
                                                    <?php echo loadDepartment($conn)?>
                                                </select>
                                            </div>
                                        </div>
                                     </div>
                                ...
                                <div class="card">
                                    <div class="card-header" >
                                            <strong class="card-title">ตารางการเข้าสู่ระบบ</strong>
                                    </div>

                                    <div class="card-body">

                                        <table class="table table-striped table-bordered" id="logaccess-table">
                                            <thead>
                                                <tr style=" border-left-width: thick;">
                                                    <th style="  text-align: center; ">รหัส</th>
                                                    <th style="  text-align: center; ">ชื่อ-นามสกุล</th>
                                                    <th style="  text-align: center; ">สังกัดสำนัก</th>
                                                    <th style="  text-align: center; ">หมายเลขไอพีแอดเดรส</th>
                                                    <th style="  text-align: center; ">แพลตฟอร์ม</th>
                                                    <th style="  text-align: center; width: 20%;">วันและเวลา</th>
                                                    <th ></th>
                                                    <th ></th>
                                                    <th style="  text-align: center;">การใช้งาน</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                            </tbody>
    ...
    <script src="../assets/hrdi_js/logaccess.js"></script>
