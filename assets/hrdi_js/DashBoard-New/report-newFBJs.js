...
(function ($) {
    ...
    $('#excel_totalMonthy').click(function(){
        exportTableToExcel("totalMonthy", "รายได้การจำหน่ายผลผลิตของลุ่มน้ำจำแนกรายเดือน");
    });

    $('#excel_totalBasinMarket').click(function(){
        exportTableToExcel("totalBasinMarket", "ปริมาณและมูลค่าการจำหน่ายของแต่ละลุ่มน้ำ");
    });
    ...
    function loadTableTotalMarket(yearsId, basinId, areaId) {
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                $("#totalMarketTitle").html("การส่งมอบผลผลิตของสถาบัน รายสาขาพืช ปีงบประมาณ พ.ศ. "+yearsId+" จำแนกตามช่องทางการตลาด");
