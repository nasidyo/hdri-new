...
(function ($) {
    ...
    $('#excel_totalMarket').click(function(){
            ...
            exportTableToExcel("totalMarket", "การส่งมอบผลผลิตของสถาบัน");
   });
    ...
    function loadTableTotalMarket(yearsId) {
        ...
        $.ajax({
            ...
            success:function(data){
                $("#totalMarket tbody").html("");
                $("#totalMarketTitle").html("การส่งมอบผลผลิตของสถาบัน รายสาขาพืช จำแนกตามช่องทางการตลาด ปีงบประมาณ พ.ศ. "+yearsId);
