<?php
    ...
    $sql = "SELECT top 6 pt.firstName+' '+pt.lastName as fullname , pt.picName , a2.target_name , sum(pmt.TotalValue) as total
                ...
                WHERE pmt.YearID = '".$_POST["yearsId"]."' and pmt.Area_idArea = '".$_POST["area_Id"]."'
