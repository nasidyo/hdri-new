...
$conn=  $db->getConnection();
   ...
   $sql= " SELECT temp.idYearTB, SUM(temp.totalsell) totalsell, SUM(temp.totalplan) totalplan
         FROM ( SELECT DISTINCT TOP 5 yt.idYearTB, ISNULL(sum(pmt.Volumn), 0) totalsell, 0 totalplan
            FROM YearTB yt 
         ...
         $sql.="group by yt.idYearTB 
            ...
            UNION
            SELECT DISTINCT TOP 5 yt2.idYearTB, 0 totalsell, ISNULL(sum(tp.Weight), 0) totalplan
            FROM YearTB yt2 
