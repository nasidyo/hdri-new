...
(function ($) {
    ...
    $('#criteria #idRiverBasin').change(function(){
       ...
       /*   var queryStr="?1=1";
          ...
          var expense_detail = $("#criteria #expense_detail").val();
          ...
          if(expense_detail!=null){
              queryStr+="&expense_detail="+expense_detail;
          }

    Table = $('#main #OtherExpenseTable').DataTable({
        ...
        responsive: true,
        serverSide: true,
        ajax: {url:"../server_side/OtherExpenseSS.php"+queryStr,"type": "GET"},
        order: [[ 0, "desc" ]],
        columnDefs: [{
                        'targets': [3],
                        'width': 40,
                        ...
                        'render': function (data, type, full, meta){
                            return '<div style=" font-size: 20px; "  ><i class="fa fa-edit" style=" cursor: pointer;margin-right: 10px;" data-toggle="modal" data-target="#editExpenseOther" data-id="'+data+'" id="editExpenseOther"></i> </div>';
                        }
                    },
                    {
                        "targets": [0],
