        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                      <!-- start Header -->
                        <div class="card-header">
                            <h5 class="card-title" id="totalMarketTitle" >มูลค่าการส่งมอบผลผลิต จำแนกรายสาขาและลุ่มน้ำ ปีงบประมาณ พ.ศ. <?php
                                                $yearsName = '';
                                                $sql = "( SELECT nameYear
                                                FROM
                                                    YearTB
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title" id="cardHeaderPieChart">สัดส่วนมูลค่าการส่งมอบผลผลิตของแต่ละลุ่มน้ำ</h5>
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                    <i class="fas fa-minus"></i>
                                </button>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <!-- start Header -->
                        <div class="card-header">
                            <h5 class="card-title" id="cardHeaderMarketChart">สัดส่วนมูลค่าช่องทางการตลาดเปรียบเทียบรายสาขา</h5>
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                    <i class="fas fa-minus"></i>
                                </button>
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <!-- start Header -->
                        <div class="card-header">
                            <h5 class="card-title">กราฟเปรียบเทียบรายได้จากการจำหน่ายผลผลิตของแต่ละลุ่มน้ำ</h5>
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                    <i class="fas fa-minus"></i>
                                </button>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                      <!-- start Header -->
                        <div class="card-header">
                            <h5 class="card-title">เปรียบเทียบรายได้การจำหน่ายผลผลิตของลุ่มน้ำจำแนกรายเดือน</h5>
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                    <i class="fas fa-minus"></i>
                                </button>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">ปริมาณและมูลค่าการจำหน่ายของแต่ละลุ่มน้ำ จำแนกตามช่องทางการตลาด</h5>
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                    <i class="fas fa-minus"></i>
                                </button>
