...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">ภาพรวมสถาบัน</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                        <li class="breadcrumb-item active">ภาพรวมสถาบัน</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                      <!-- start Header -->
                        <div class="card-header">
                            <h5 class="card-title" id="totalMarketTitle" >มูลค่าส่งมอบผลผลิตของสถาบัน รายสาขาพืช ปีงบประมาณ พ.ศ. <?php
                                                $yearsName = '';
                                                $sql = "( SELECT nameYear
                                                FROM
                                                    YearTB
                      ...
                      <!-- start body -->
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                  ...
                                  <table id="totalMarket" class="table m-0 table-bordered table-striped" style="text-align: center;">
                                      <thead>
                                          <tr>
                                              <th rowspan="2">รายสาขา</th>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">สัดส่วนร้อยละมูลค่าส่งมอบผลผลิตของสถาบัน จำแนกรายสาขาพืช</h5>
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                    <i class="fas fa-minus"></i>
                                </button>
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">สัดส่วนร้อยละมูลค่าส่งมอบผลผลิตของสถาบัน จำแนกรายช่องทางตลาด</h5>
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                    <i class="fas fa-minus"></i>
                                </button>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                      <!-- start Header -->
                        <div class="card-header">
                            <h5 class="card-title">สัดส่วนมูลค่าส่งมอบผลผลิตรายสาขาพืชของสถาบัน จำแนกตามช่องทางการตลาด</h5>
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                    <i class="fas fa-minus"></i>
                                </button>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                      <!-- start Header -->
                        <div class="card-header">
                            <h5 class="card-title">มูลค่าเป้าหมายและส่งมอบผลผลิตของสถาบัน จำแนกรายเดือน</h5>
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                    <i class="fas fa-minus"></i>
                                </button>
...
<script src="../assets/hrdi_js/DashBoard-New/report-newJs.js"></script>