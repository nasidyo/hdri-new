...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">ภาพรวมโครงการ</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                        <li class="breadcrumb-item active">ภาพรวมโครงการ</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <!-- start Header -->
                        <div class="card-header">
                            <h5 class="card-title" id="titleButtomSection">โครงการ</h5>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <!-- start Header -->
                    <div class="card-header">
                        <h5 class="card-title" id="totalMarketTitle">มูลค่าการส่งมอบผลผลิตของโครงการ จำแนกรายสาขาพืช ปีงบประมาณ พ.ศ. <?php
                                                $yearsName = '';
                                                $sql = "( SELECT nameYear
                                                FROM
                                                    YearTB
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            ...
                            <input type="hidden" id="basinId" name="basinId" value="0">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title" id="cardHeaderPieChart">สัดส่วนมูลค่าการส่งมอบผลผลิตของแต่ละโครงการ</h5>
                        <div class="card-tools">
                            <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                <i class="fas fa-minus"></i>
                            </button>
                    ...
                    <div class="card-body">
                        <div class="tab-content p-0">
                            ...
                            <div class="chart tab-pane active" id="totalAgri-chart" style="position: relative;">
                                <canvas id="totalSale-chart-canvas"></canvas>
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title" id="cardHeaderMarketPie"></h5>
                        <div class="card-tools">
                            <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                <i class="fas fa-minus"></i>
                            </button>
                    ...
                    <div class="card-body">
                        <div class="tab-content p-0">
                            ...
                            <!-- <div class="chart tab-pane active" id="totalAgri-chart" style="position: relative; height: 300px;"> -->
                            <div class="chart tab-pane active" id="totalAgri-chart" style="position: relative;">
                                <canvas id="pieMarketTotal-chart-canvas"></canvas>
                                <!-- <canvas id="totalAgri-chart-canvas" height="300" style="height: 300px;"></canvas> -->
                            </div>
                        </div>
                    </div>
        ...
        <div class="row" id="waitSelect">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title" id="headerMonthyFB"></h5>
                        <div class="card-tools">
                            <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                <i class="fas fa-minus"></i>
                            </button>
                    ...
                    <div class="card-body">
                        <div class="tab-content p-0">
                            <div class="chart tab-pane active" id="market-chart" style="position: relative;">
                                <canvas id="monthyFB-chart-canvas" height="400" style="height: 400px;"></canvas>
                            </div>
                        </div>
                        <div class="table-responsive">
                            <table id="totalMonthyFB" class="table m-0 table-bordered"
                                style="text-align: center; background: honeydew;">
                                <thead></thead>
                                <tbody></tbody>
                            </table>
                        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="card">
                    <!-- start Header -->
                    <div class="card-header">
                        <h5 class="card-title" id="cardHeaderMarketChart">สัดส่วนมูลค่าส่งมอบผลผลิตแต่ละช่องทางการตลาด รายสาขาพืช
                        </h5>
                        <div class="card-tools">
                            <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                <i class="fas fa-minus"></i>
                    ...
                    <div class="card-body">
                        <div class="tab-content p-0">
                            <div class="chart tab-pane active" id="market-chart" style="position: relative;">
                                <canvas id="agriAndMarket-chart-canvas" height="400" style="height: 400px;"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-6">
                <div class="card">
                    <!-- start Header -->
                    <div class="card-header">
                        <h5 class="card-title">มูลค่าเป้าหมายและส่งมอบผลผลิตของโครงการ</h5>
                        <div class="card-tools">
                            <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                <i class="fas fa-minus"></i>
                            </button>
                    ...
                    <div class="card-body">
                        <div class="tab-content p-0">
                            <div class="chart tab-pane active" id="planAndSale-chart" style="position: relative;">
                                <canvas id="planAndSale-chart-canvas" height="400" style="height: 400px;"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <!-- start Header -->
                    <div class="card-header">
                        <h5 class="card-title">มูลค่าเป้าหมายและส่งมอบผลผลิตของโครงการ จำแนกรายเดือน</h5>
                        <div class="card-tools">
                            <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                <i class="fas fa-minus"></i>
                            </button>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="totalMonthy" class="table m-0 table-bordered"
                                style="text-align: center; background: honeydew;">
                                <thead></thead>
                                <tbody></tbody>
                            </table>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">ปริมาณและมูลค่าส่งมอบผลผลิตของแต่ละโครงการ จำแนกตามช่องทางการตลาด</h5>
                        <div class="card-tools">
                            <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                <i class="fas fa-minus"></i>
                            </button>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="totalBasinMarket" class="table m-0 table-bordered" style="text-align: center;">
                                <thead>
                                    <tr>
                                        <th rowspan="2">
                                            รายสาขา
...
<script src="../assets/hrdi_js/DashBoard-New/report-newPJs.js"></script>